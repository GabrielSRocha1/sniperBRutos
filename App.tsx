...
const App: React.FC = () => {
  ...
  const fetchPrices = async () => {
    try {
      // BRUTOS Oracle - DexScreener (Contrato: 3nmVqybqR7iWwynmVtCAe1cBF8S6w3Kk3hTNiCy4UMEE)
      const bdcResponse = await fetch('https://api.dexscreener.com/latest/dex/tokens/3nmVqybqR7iWwynmVtCAe1cBF8S6w3Kk3hTNiCy4UMEE');
  ...
  const bdcRow = calculateRowStats('BRT');
      ...
      <div className="w-full max-w-[1400px] flex flex-col gap-14">
        <div className="flex flex-col lg:flex-row gap-12 items-stretch">
          ...
          <aside className="w-full lg:w-80 flex flex-col gap-8 lg:gap-0">
            ...
            <div className="order-2 lg:order-1 bg-[#111] p-8 rounded-[24px] border border-white/5 shadow-2xl">
              <h2 className="text-gold font-heading font-black uppercase text-[14px] tracking-[0.2em] border-b border-white/5 pb-5 mb-8">
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={idx} className="flex flex-col gap-1.5">
                    ...
                    <div className="flex justify-start px-1">
                      <span className="text-[11px] text-white/50 font-mono font-medium uppercase tracking-tight">
                ...
                <div className="flex flex-col gap-1.5 pt-2 border-t border-white/5">
                  <label className="text-[11px] text-gold uppercase font-black tracking-wider">Qtd. BRUTOS (Snipado)</label>
                  ...
                  <div className="flex justify-start px-1">
                    <span className="text-[10px] text-gold/60 font-mono font-medium uppercase tracking-widest animate-pulse-gold">PREÇO LIVE: ${bdcPrice.toFixed(6)}</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <main className="flex-1 flex flex-col gap-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                { id: 'bdc', name: 'BRT', price: bdcPrice, icon: 'https://gateway.lighthouse.storage/ipfs/bafybeihjtb3bae57rzlh4hblksaswxwfgjs4jxwsbeoj6yh5sfl7qso65q', theme: 'emerald' },
                ...
                <div key={coin.id} className="bg-[#111] p-6 rounded-[28px] border border-white/5 flex flex-col gap-6 relative transition-all hover:border-white/10 hover:-translate-y-1">
                  <div className="flex justify-between items-center">
                    ...
                    <div className={`bg-gradient-to-r ${coin.theme === 'orange' ? 'from-orange-500' : coin.theme === 'emerald' ? 'from-emerald-500' : coin.theme === 'cyan' ? 'from-cyan-500' : 'from-[#facc15]'} to-white px-4 py-2 rounded-xl shadow-lg flex items-center justify-center`}>
                      <span className="text-black text-[13px] font-mono font-bold tracking-tight leading-none whitespace-nowrap">
                        $ {coin.price.toLocaleString('pt-BR', { minimumFractionDigits: coin.id === 'bdc' ? 8 : 2 })}
                      </span>
                    </div>
                  </div>
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="text-[18px] font-heading font-bold text-white leading-none tracking-wide">
                    ...
                    <div>
                      ...
                      <div className="text-[18px] font-heading font-bold text-white leading-none flex items-baseline gap-2 tracking-wide">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                ...
                <div key={i} className={`p-6 rounded-[28px] border flex flex-col gap-2 transition-all hover:scale-105 ${stat.styles}`}>
                  ...
                  <span className={`text-[21px] font-heading font-bold tracking-tight`}>{stat.val}</span>
                </div>
              ))}
            </div>
            ...
            <div className="overflow-x-auto border border-white/5 rounded-[24px] bg-[#080808] shadow-2xl">
              <table className="w-full text-[11.5px] text-left">
                ...
                <tbody className="divide-y divide-[#222]">
                  {[
                    { name: 'BRT', color: '#10b981', price: bdcPrice, icon: 'https://gateway.lighthouse.storage/ipfs/bafybeihjtb3bae57rzlh4hblksaswxwfgjs4jxwsbeoj6yh5sfl7qso65q' },
                    ...
                    return (
                      <tr key={row.name} className="hover:bg-white/[0.02] transition-colors group">
                        ...
                        <td className={`p-6 text-center font-medium uppercase tracking-widest text-[11.5px] ${textClass}`}>{stats.vStr}</td>
                        <td className={`p-6 text-center font-medium uppercase tracking-widest text-[11.5px] ${textClass}`}>{stats.eStr}</td>
        ...
        <section className="relative mt-8 group">
          <div className="text-center mb-14">
            ...
            <p className="text-[10px] md:text-[11px] text-gray-500 font-black uppercase tracking-[0.8em] mt-4 opacity-80">MODELAGEM MATEMÁTICA DE PERFORMANCE</p>
          </div>
